...
namespace toinfiniityandbeyond.PixelEditor
{
	...
	public class BlendModeUtility
	{
		public static Texture2D Blend (Texture2D lowerLayer, float lowerOpacity, Texture2D upperLayer, float upperOpacity, BlendMode mode)
		{
			switch (mode)
			{
